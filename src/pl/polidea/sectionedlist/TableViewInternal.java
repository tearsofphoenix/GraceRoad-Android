 ...
 */
public class TableViewInternal extends ListView implements OnScrollListener {

    private View transparentView;

    public TableViewInternal(final Context context, final AttributeSet attrs, final int defStyle) {
        super(context, attrs, defStyle);
        commonInitialisation();
    }

    public TableViewInternal(final Context context, final AttributeSet attrs) {
        super(context, attrs);
        commonInitialisation();
    }

    public TableViewInternal(final Context context) {
        super(context);
        commonInitialisation();
    }
